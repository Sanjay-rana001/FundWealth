...
export function Testimonials() {
  const allTestimonials = [
    ...
    { text: "Their active rebalancing saved my portfolio during the market correction. Highly recommend their wealth advisory services.", author: "Amit B.", role: "Business Owner", image: "/images/investor_3.png" },
    ...
    { text: "Their tax-harvesting strategies alone paid for their advisory fees multiple times over. Brilliant execution.", author: "Karan D.", role: "CA", image: "/images/investor_3.png" },
    ...
    { text: "The onboarding was seamless, and my dedicated advisor actually listens to my risk appetite.", author: "Nidhi P.", role: "Software Engineer", image: "/images/investor_2.png" },
